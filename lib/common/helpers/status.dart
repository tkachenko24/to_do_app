...
abstract class Status<E, S> {
  ...
  bool isNoInternet() {
    return when(other: () => false, noInternet: () => true);
  }

  bool isNoPermission() {
    return when(other: () => false, noPermission: () => true);
  }
  ...
  static Status<E, S> noInternet<E, S>() => NoInternetStatus();

  static Status<E, S> noPermission<E, S>() => NoPermissionStatus();
  ...
  W when<W>({
    ...
    W Function()? noInternet,
    W Function()? noPermission,
...
@immutable
class NoInternetStatus<E, S> extends Status<E, S> {
  @override
  W when<W>({
    W Function()? empty,
    W Function()? loading,
...
@immutable
class NoPermissionStatus<E, S> extends Status<E, S> {
  @override
  W when<W>({
    W Function()? empty,
    W Function()? loading,
